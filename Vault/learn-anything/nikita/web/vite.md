...
- [Vite Image Optimizer](https://github.com/FatehAK/vite-plugin-image-optimizer) - Optimize your image assets using Sharp.js and SVGO.
- [Vite Bundle Visualizer](https://github.com/KusStar/vite-bundle-visualizer)
- [vite-plugin-prebundle](https://github.com/antfu/vite-plugin-prebundle) - Pre-bundle local entries from your Vite app to reduce network requests.

...
- [Chrome extension template with Rust and React](https://github.com/jondot/react-rust-chrome-starter)
- [Netify](https://github.com/vladlavrik/netify) - Chrome extension to intercept and modify network requests.

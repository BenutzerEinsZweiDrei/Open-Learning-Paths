...
- [WebRTC support being added to FFmpeg](https://news.ycombinator.com/item?id=36130191)
- [OBS Merges WebRTC Support](https://news.ycombinator.com/item?id=36273075)
- [Waveguide](https://github.com/Glimesh/waveguide) - Polyglot WebRTC media server.
- [3LAS](https://github.com/JoJoBond/3LAS) - Browser-based low latency audio streaming solution for use in mobile devices.
- [S.A.T.U.R.D.A.Y](https://github.com/GRVYDEV/S.A.T.U.R.D.A.Y) - Toolbox for working with WebRTC, Audio and AI.

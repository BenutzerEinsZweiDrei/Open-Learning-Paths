...
I love the fact that I can set up any new mac or phone to use my exact and perfect setup without any cruft in seconds. All my [dotfiles](https://github.com/nikitavoloboev/dotfiles) are online and can be setup on any new mac via few commands, thanks to [Nix](../package-managers/nix/index.md) and some scripts I wrote. I try keep everything declarative so it's reusable by all, including me.

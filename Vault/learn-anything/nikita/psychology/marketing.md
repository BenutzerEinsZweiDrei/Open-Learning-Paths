...
Building a brand that people recognize and like takes time but ultimately it's about iterating on product [thoughtful & fast](../management/index.md). Communicating releases well. And having clear feedback channels with your customers. If [user based analytics](../analytics/index.md) are used, they should focus on getting closer to great product.
...
- [Dittofeed](https://github.com/dittofeed/dittofeed) - Send marketing messages at scale.

...
- [Using linear() for better animation (2023)](https://fullystacked.net/posts/linear/)
- [dotLottie Web Component](https://github.com/dotlottie/player-component) - Embedding and playing dotLottie animations on websites.
- [Animating with Code - Motion Canvas](https://www.youtube.com/watch?v=WTUafAwrunE)
- [AutoAnimate](https://auto-animate.formkit.com/) - Add motion to your apps with a single line of code. ([Code](https://github.com/formkit/auto-animate))

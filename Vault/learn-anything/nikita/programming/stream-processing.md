...
[ksqlDB](https://ksqldb.io/) & [RisingWave](https://github.com/risingwavelabs/risingwave) are neat. I use [go-streams](https://github.com/reugn/go-streams) for stream processing in [Go](../programming-languages/go/index.md).

...
- [bufls](https://github.com/bufbuild/buf-language-server) - Protobuf language server compatible with Buf.
- [proto-gen](https://github.com/EmbarkStudios/proto-gen) - Protobuf to Rust code generation using tonic-build.
- [protovalidate-go](https://github.com/bufbuild/protovalidate-go) - Protocol Buffer Validation.
- [Cybozu Public Protocol Buffers Schema](https://github.com/cybozu/protobuf) - Normalization and validation system for Protocol Buffers.
- [protovalidate](https://github.com/bufbuild/protovalidate) - Protocol Buffer Validation.

...
- [Jim](https://github.com/seeM/Jim) - Simple, beautiful Jupyter notebook editor for macOS.
- [GoNB](https://github.com/janpfeifer/gonb) - Go Notebook Kernel for Jupyter.
- [Copilot for Jupyter notebooks](https://github.com/Akramz/jupyter_plz)
- [Vector Database in a Jupyter Notebook (2023)](https://zilliz.com/blog/exploring-magic-vector-databases-jupyter-notebooks) ([HN](https://news.ycombinator.com/item?id=36207009))
- [Go replacement for the Kubeflow Jupyter Web APIs](https://github.com/StatCan/jupyter-apis)
- [Jupyter Real-Time Collaboration](https://github.com/jupyterlab/jupyter_collaboration)
- [JupyterLab 4.0 (2023)](https://blog.jupyter.org/jupyterlab-4-0-is-here-388d05e03442) ([HN](https://news.ycombinator.com/item?id=36315796))

...
Love [VitePress](../tools/vitepress.md) and use it for all my docs.

[Mint](https://github.com/mintlify/mint), [Markdoc](https://markdoc.io/) & [nbdoc](https://twitter.com/HamelHusain/status/1507383929774305282) look nice too.

[React Docs](https://react.dev/) is a great example of what great docs are. I love their illustrations.
...
- [VitePress Sidebar](https://github.com/jooy2/vitepress-sidebar) - Plugin for VitePress that automatically configures and manages the sidebar of your page with simple settings.
- [Link Checker](https://github.com/grammyjs/link-checker) - Tool for checking broken links in grammY documentation.
- [The Surprising Power of Documentation (2023)](https://vadimkravcenko.com/shorts/proper-documentation/) ([HN](https://news.ycombinator.com/item?id=36287809))

...
- [JJ](https://github.com/tidwall/jj) - JSON Stream Editor. ([HN](https://news.ycombinator.com/item?id=36067958))
- [json-ext](https://github.com/discoveryjs/json-ext) - Set of performant and memory efficient utilities that extend the use of JSON.
- [I wish JSON5 was more popular (2023)](https://evertpot.com/json5/)
- [JSON Stream Stringify](https://github.com/Faleij/json-stream-stringify) - JSON.Stringify as a readable stream.

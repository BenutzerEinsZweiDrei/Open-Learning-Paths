...
- [Azurite](https://github.com/Azure/Azurite) - Lightweight server clone of Azure Storage that simulates most of the commands supported by it with minimal dependencies.

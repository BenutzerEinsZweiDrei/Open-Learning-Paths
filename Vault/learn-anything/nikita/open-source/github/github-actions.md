...
- [Workflow Telemetry](https://github.com/runforesight/workflow-telemetry-action) - Github action to collect metrics (CPU, memory, I/O, etc ...) from your workflows to help you debug and optimize your CI/CD pipeline.
- [log](https://github.com/azurystudio/log) - Smart way of managing changes.
...
- [Install Rust Toolchain](https://github.com/actions-rust-lang/setup-rust-toolchain)
...
- [setup-micromamba](https://github.com/mamba-org/setup-micromamba) - GitHub Action to set up the micromamba package manager.
...
- [Cancel Previous Runs](https://github.com/n1hility/cancel-previous-runs)

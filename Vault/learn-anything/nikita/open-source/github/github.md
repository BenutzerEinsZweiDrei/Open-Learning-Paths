...
[Probot](https://github.com/probot/probot) is nice for writing GitHub automations. [Octocrab](https://github.com/XAMPPRocky/octocrab) is nice [Rust](../../programming-languages/rust/index.md) GitHub library.
...
- [GitLight](https://gitlight.vercel.app/) - GitHub and GitLab notifications on your desktop. ([Code](https://github.com/colinlienard/gitlight))
- [Analysis of the GitHub Copilot extension](https://github.com/saschaschramm/github-copilot)
- [Code Repository Explorer](https://github.com/cmooredev/RepoReader) - Explore and ask questions about a GitHub code repository using OpenAI's GPT.

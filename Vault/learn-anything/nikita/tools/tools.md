...
- [Sketch.systems](https://sketch.systems/) - Helps software designers think about complex product behavior. Sketch out states, add prototypes, and clarify questions quickly. ([HN](https://news.ycombinator.com/item?id=36378731))
...
- [Plane](https://plane.so/) - Open Source JIRA, Linear and Height Alternative. ([Code](https://github.com/makeplane/plane)) ([HN](https://news.ycombinator.com/item?id=36129594))
...
- [Koala](https://koala.sh/) - AI Writer and Chatbot.
- [D2 TS](https://github.com/Kreshnik/d2lang-js) - Interface for building D2 diagram files in JS.
- [QR code designer](http://robko.ch/qr-designer/) ([Code](https://github.com/kochrt/qr-designer))
- [Atinotes](https://github.com/Atinux/atinotes) - Editable website with universal rendering on the edge (CF workers).
- [Twenty](https://twenty.com/) - Open Source CRM. ([Code](https://github.com/twentyhq/twenty))
- [Ask HN: Dev productivity tools you would pay for (2023)](https://news.ycombinator.com/item?id=36267563)
- [Ask HN: What's a good, privacy focused bookmark manager? (2023)](https://news.ycombinator.com/item?id=36287947)
- [Non.io](https://non.io/) - Platform for creators. ([HN](https://news.ycombinator.com/item?id=36296695))
- [What are the ultimate tools for the modern SaaS stack? (2023)](https://twitter.com/maccaw/status/1667941073094836224)
- [Dorf](https://github.com/matheins/Dorf) - Free and open source form builder.
- [Markup Link Checker](https://github.com/becheran/mlc) - Check for broken links in markup files (HTML/Markdown).

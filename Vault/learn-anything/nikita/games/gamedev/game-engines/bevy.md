...
- [vx_bevy](https://github.com/Game4all/vx_bevy) - Minecraft-esque voxel engine rendering prototype made using the Bevy game engine.
- [Bevy Pan/Orbit Camera](https://github.com/Plonq/bevy_panorbit_camera) - Simple pan and orbit camera for the Bevy game engine.
- [Bevy XPBD](https://github.com/Jondolf/bevy_xpbd) - 2D and 3D physics engine based on Extended Position Based Dynamics for Bevy.

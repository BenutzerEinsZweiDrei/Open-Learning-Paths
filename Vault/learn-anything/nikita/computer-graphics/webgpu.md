...
[MachGPU](https://machengine.org/gpu/)'s [Zig](../programming-languages/zig/index.md) bindings are great.
...
- [WebGPU Avoid Redundant State Setting](https://github.com/greggman/webgpu-avoid-redundant-state-setting)

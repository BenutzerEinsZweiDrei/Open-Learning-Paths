...
- [Infino](https://github.com/infinohq/infino) - Fast and scalable service to store time series and logs - written in Rust.
- [OpenObserve](https://github.com/openobserve/openobserve) - Elasticsearch/Datadog alternative. ([HN](https://news.ycombinator.com/item?id=36280028))

...
- [Whisper Web](https://github.com/xenova/whisper-web) - ML-powered speech recognition directly in your browser! Built with 🤗 Transformers.js.
- [Diffusion-based Generative Speech Source Separation (2023)](https://arxiv.org/abs/2210.17327) ([Code](https://github.com/fakufaku/diffusion-separation))
- [EasyMMS](https://github.com/abdeladim-s/easymms) - Simple Python package to easily use Meta's Massively Multilingual Speech (MMS) project.
- [SpeechPrompt v2: Prompt Tuning for Speech Classification Tasks (2023)](https://arxiv.org/abs/2303.00733) ([Code](https://github.com/ga642381/SpeechPrompt-v2))

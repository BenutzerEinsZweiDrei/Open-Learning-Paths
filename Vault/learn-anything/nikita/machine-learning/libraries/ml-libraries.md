...
- [Outlines](https://github.com/normal-computing/outlines) - Generative Model Programming. ([Tweet](https://twitter.com/remilouf/status/1661739178466611200))
- [crepes](https://github.com/henrikbostrom/crepes) - Conformal regressors and predictive systems.
- [Loopy](https://github.com/inducer/loopy) - Transformation-Based Generation of High-Performance CPU/GPU Code.
- [MSPrior](https://github.com/caillonantoine/msprior) - Multi(scale/stream) prior model for realtime temporal learning.
- [EasyRunner](https://github.com/liuzuxin/easy-runner) - Lightweight tool for efficiently managing and executing parallel experiments.
- [synthcity](https://github.com/vanderschaarlab/synthcity) - Library for generating and evaluating synthetic tabular data for privacy, fairness and data augmentation.

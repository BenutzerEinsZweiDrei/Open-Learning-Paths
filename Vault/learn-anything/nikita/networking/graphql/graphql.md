...
- [Using @defer Directive with GraphQL Code Generator (2023)](https://the-guild.dev/blog/defer-support-codegen)
- [GraphQL and Type Systems (2023)](https://hypirion.com/musings/graphql-and-type-systems)
- [Top 5 tools every frontend developer should be using with GraphQL in 2023](https://www.youtube.com/watch?v=AV4Amf3Mag0) ([Tweet](https://twitter.com/notrab/status/1663503833736044546))
- [GraphQL Education](https://graphql-education.pages.dev/) ([Code](https://github.com/the-guild-org/graphql-education))
- [Go GraphQL Client](https://github.com/hasura/go-graphql-client) - Provides a GraphQL client implementation.
- [Building real time apps with Server-Sent Events and GraphQL (2023)](https://grafbase.com/blog/building-realtime-apps-with-server-sent-events-and-graphql)
- [Isograph](https://github.com/isographlabs/isograph) - Build React apps backed by GraphQL data.
- [Migrating Netflix to GraphQL safely (2023)](https://netflixtechblog.com/migrating-netflix-to-graphql-safely-8e1e4d4f1e72) ([HN](https://news.ycombinator.com/item?id=36381764))
- [GraphQL Rate Limit](https://github.com/ravangen/graphql-rate-limit) - Fixed window rate limiting middleware for GraphQL.

...
This is my personal wiki where I share [everything I know](sharing/everything-I-know.md) about this world in form of an [online wiki](other/wiki-workflow.md) built with [VitePress](tools/vitepress.md). It's [1,000+ of topics on all kinds of things](#contents). [Updated daily](updates.md).
...
I [update it daily](updates.md). I use the website and the [search plugin](https://github.com/nikitavoloboev/alfred-my-mind) I built for it together with the search bar (or CMD+K hotkey) to query the content inside.
...
For example take [programming languages](programming-languages/index.md), it's top level folder. All of these pages are part of programming languages:
...
As you can see, SolidJS is part of [JS libraries](programming-languages/javascript/js-libraries/index.md) which is part of [JavaScript](programming-languages/javascript/index.md) and JavaScript as a language is part of top level [programming languages](programming-languages/index.md) I mentioned above. There are [tons more folders like this](#contents). The way I include what's part of what is subject to my interpretation and it might be wrong or confusing.
...
[Here](sharing/index.md) you can find all the things I made and shared thus far.
...
- [Karabiner](macOS/apps/karabiner/index.md) as it describes a genuinely life changing tool that makes updating this wiki and operating my mac at fast speeds possible
- [VSCode](text-editors/vs-code/index.md) & [Sublime Text](text-editors/sublime-text/index.md) for similar reason as Karabiner, life changing tools. I use Sublime Text for [editing this wiki](other/wiki-workflow.md) and VSCode for writing [code](programming/index.md). Mostly [TypeScript](programming-languages/typescript/index.md) and [Go](programming-languages/go/index.md) now.
- [Happiness](life/happiness.md) includes my lessons I learned for how to live a happier life
- [Focusing](focusing/index.md) as it's a very important page for me. It links to other important to me pages: [Rules](focusing/rules.md) & [Habits](focusing/habits.md). These 2 pages are essentially a summary of my life as far as my value system / lessons learned / habits go.
- [Relationships](relationships/index.md) is another important to me area in life as I want to be someone friends think fondly of and it contains my thoughts on that
- [My Workflow](sharing/my-workflow.md) includes a summary of what I use in life.
- [Looking Back](looking-back/index.md) as it's my life diary. It includes a lot of how I felt, what I thought about and did at any point in time starting from 2017 when I first started writing a journal.

There is a lot more out there but I think above is a good start. Hope you find some of it interesting. ♥️

As far as tech goes, my current obsessions, [goals](focusing/goals.md) and [ideas](ideas/index.md) for how to live a [better future](future/index.md) are [learning](education/learning.md) more of [Solid](programming-languages/javascript/js-libraries/solid.md) and [Go](programming-languages/go/index.md)/[Swift](programming-languages/swift/index.md) to build [amazing experiences](design/design-inspiration.md).
...
3. Subtopics - Various subtopics related to the main topic. i.e. [Alfred](macOS/apps/alfred/index.md) page has a few subtopics.
...
- [Biology](biology/index.md)
  - [Bioinformatics](biology/bioinformatics/index.md)
  ...
  - [Immunology](biology/immunology/index.md)
...
- [Business](business/index.md)
  ...
  - [Restaurants](business/restaurants.md)
    ...
    - [Startups](business/startups/index.md)
...
- [Cloud computing](cloud-computing/index.md)
  ...
  - [Azure](cloud-computing/azure/index.md)
  - [Fly io](cloud-computing/fly-io.md)
  - [Google Cloud](cloud-computing/gcp/index.md)
  - [Serverless computing](cloud-computing/serverless-computing/index.md)
...
- [Compilers](compilers/index.md)
  - [Build systems](compilers/build-systems/index.md)
...
- [Computer Science](computer-science/index.md)
  - [Algorithms](computer-science/algorithms/index.md)
...
- [Cryptocurrencies](cryptocurrencies/index.md)
...
- [Databases](databases/index.md)
  - [Blockchain](databases/blockchain/index.md)
...
- [Distributed systems](distributed-systems/index.md)
  ...
  - [Message queue](distributed-systems/message-queue/index.md)
...
- [Documentaries](documentaries/index.md)
- [Drugs](drugs/index.md)
  ...
  - [Psychedelics](drugs/psychedelics/index.md)
    - [Ketamine](drugs/psychedelics/ketamine.md)
    - [Lysergamides](drugs/psychedelics/lysergamides/index.md)
      - [LSD](drugs/psychedelics/lysergamides/lsd.md)
  - [Microdosing](drugs/psychedelics/microdosing.md)
  - [Phenethylamines](drugs/psychedelics/phenethylamines/index.md)
  - [Salvia](drugs/psychedelics/salvia.md)
  - [Trippy](drugs/psychedelics/trippy.md)
  - [Tryptamines](drugs/psychedelics/tryptamines/index.md)
...
- [Environment](environment/index.md)
  - [Renewable energy](environment/renewable-energy/index.md)
...
- [Languages](languages/index.md)
  ...
  - [English](languages/english/index.md)
...
- [macOS](macOS/index.md)
  ...
  - [apps](macOS/apps/macOS-apps.md)
    ...
    - [Alfred](macOS/apps/alfred/index.md)
  ...
  - [Karabiner](macOS/apps/karabiner/index.md)
  - [Keyboard Maestro](macOS/apps/keyboard-maestro/index.md)
...
- [Math](math/index.md)
  ...
  - [Category theory](math/category-theory/index.md)
  ...
  - [Logic](math/logic/index.md)
    - [Automated theorem proving](math/logic/automated-theorem-proving/index.md)
  ...
  - [Mathematical optimization](math/mathematical-optimization/index.md)
  ...
  - [Statistics](math/statistics/index.md)
    - [Markov chains](math/statistics/markov-chains.md)
  - [Topology](math/topology.md)
  - [Type Theory](math/type-theory/index.md)
...
- [Music](music/index.md)
  ...
  - [Music production](music/music-production/index.md)
...
- [Networking](networking/index.md)
  ...
  - [Peer to peer](networking/peer-to-peer/index.md)
...
- [Philanthropy](philanthropy/index.md)
...
- [Physics](physics/index.md)
  ...
  - [Electrical engineering](physics/electrical-engineering/index.md)
    - [Signal processing](physics/electrical-engineering/signal-processing.md)
  - [Quantum physics](physics/quantum-physics/index.md)
...
- [Programming](programming/index.md)
  ...
  - [Regex](programming/regex/index.md)
...
- [Version control](programming/version-control/index.md)
...
- [Programming languages](programming-languages/index.md)
  ...
  - [APL](programming-languages/apl/index.md)
  ...
  - [Clojure](programming-languages/clojure/index.md)
  ...
  - [D](programming-languages/d/index.md)
  - [Dart](programming-languages/dart/index.md)
  ...
  - [Elm](programming-languages/elm/index.md)
    - [Elm libraries](programming-languages/elm/elm-libraries.md)
  - [Erlang](programming-languages/erlang/index.md)
  ...
  - [Haskell](programming-languages/haskell/index.md)
    - [Haskell libraries](programming-languages/haskell/haskell-libraries/index.md)
  - [Haxe](programming-languages/haxe/index.md)
  - [Idris](programming-languages/idris/index.md)
  ...
  - [Julia](programming-languages/julia/index.md)
    - [Julia libraries](programming-languages/julia/julia-libraries.md)
  - [Kotlin](programming-languages/kotlin/index.md)
  ...
  - [Lisp](programming-languages/lisp/index.md)
    ...
    - [Nim](programming-languages/nim/index.md)
      - [Nim libraries](programming-languages/nim/nim-libraries.md)
    - [Objective C](programming-languages/objc/index.md)
    ...
    - [Processing](programming-languages/processing/index.md)
      - [p5.js](programming-languages/processing/p5js.md)
    - [Prolog](programming-languages/prolog/index.md)
      - [Datalog](programming-languages/prolog/datalog.md)
    - [Purescript](programming-languages/purescript/index.md)
    ...
    - [R](programming-languages/r/index.md)
      - [R packages](programming-languages/r/r-packages.md)
    - [ReasonML](programming-languages/reasonml/index.md)
    ...
    - [Scala](programming-languages/scala/index.md)
    ...
    - [Swift](programming-languages/swift/index.md)
...
- [Text editors](text-editors/index.md)
  ...
  - [Emacs](text-editors/emacs/index.md)
  ...
  - [Sublime Text](text-editors/sublime-text/index.md)
  ...
  - [VS Code](text-editors/vs-code/index.md)
...
- [Tools](tools/index.md)
  ...
  - [Voice assistants](tools/voice-assistants/index.md)
...
- [Web](web/index.md)
  - [Browsers](web/browsers/index.md)
    - [Bookmarklets](web/browsers/bookmarklets.md)
    - [Firefox](web/browsers/firefox.md)
    - [Google Chrome](web/browsers/google-chrome/index.md)
  ...
  - [JAMstack](web/jamstack/index.md)
  ...
  - [Spin](web/spin.md)
  - [Static sites](web/static-sites/index.md)
  ...
  - [Web Engines](web/web-engines/index.md)
...
- [Work](work/index.md)
  ...
  - [Finding work](work/finding-work/index.md)

...
- [Functional Programming in Lean](https://leanprover.github.io/functional_programming_in_lean/) ([HN](https://news.ycombinator.com/item?id=36107796))
...
- [Lean 4 port of Iris](https://github.com/larsk21/iris-lean) - Higher-order concurrent separation logic framework.
- [Uniq](https://github.com/mhuisi/Uniq) - Static Uniqueness Analysis for the Lean 4 Theorem Prover.
- [risc0-lean4](https://github.com/risc0/risc0-lean4) - Model of the RISC Zero zkVM and ecosystem in the Lean 4 Theorem Prover.

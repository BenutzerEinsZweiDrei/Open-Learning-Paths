...
- [Rash](https://github.com/willghatch/racket-rash) - The Reckless Racket Shell. ([Web](https://rash-lang.org/))
...
- [tesh](https://github.com/mickael-menu/tesh) - End-to-end tests for shell commands.
- [Historian](https://github.com/jcsalterego/historian) - Command-line utility for managing shell history in a SQLite database.
- [complgen](https://github.com/adaszko/complgen) - Generate shell completions based on a BNF-like grammar.

...
I wrote all my articles, docs & notes in [Sublime Text](../text-editors/sublime-text/index.md) app and used an [Alfred workflow](https://github.com/nikitavoloboev/small-workflows#workflow-augmentations) to search through this wiki & my blog.

...
My [preferred management style](../management/index.md) is to be fully async first (written communication, well defined tasks) with scheduled focus sync ups to make sure team is going in right direction.

...
I deploy all web services on [Cloudflare](https://www.cloudflare.com/en-gb/) and thus use their [Web Analytics](https://www.cloudflare.com/en-gb/web-analytics/) only.

I use [Tinybird](tinybird.md) for actual real logging events and doing analysis in real time.

[GoatCounter](https://www.goatcounter.com/), [PostHog](https://github.com/PostHog/posthog) & [umami](https://umami.is/) seem great for self hosting analytics too.

[Plausible](https://plausible.io/), [Netlify](https://www.netlify.com/products/analytics/) are popular options too.

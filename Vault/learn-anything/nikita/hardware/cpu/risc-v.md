...
- [Re encoding RISCV](https://github.com/shacron/sled/wiki/Re-encoding-RISCV) ([Lobsters](https://lobste.rs/s/phlfpq/re_encoding_riscv))
- [rv](https://github.com/mnurzia/rv) - RISC-V CPU core written in ANSI C. ([HN](https://news.ycombinator.com/item?id=36270150))

...
- [Filament](https://github.com/cucapra/filament) - Hardware description language (HDL) that uses a type system to specify and compose hardware pipelines.
- [10Gb Ethernet Switch in Verilog](https://github.com/ZipCPU/eth10g)
